...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { name: "Diário de Bordo", href: "/diario-bordo", icon: ClipboardList, roles: ['admin', 'teacher'] },
    ...
    <div className="w-72 bg-[#0F172A] flex flex-col h-screen sticky top-0 shrink-0">
      <div className="p-8">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xl font-black text-white tracking-tight uppercase">Acelera</span>
        </div>
      </div>
          ...
          return (
            <Link 
              ...
              className={`flex items-center justify-between px-4 py-3.5 rounded-2xl transition-all group ${
                isActive ? "bg-blue-600 text-white shadow-lg shadow-blue-900/20" : "text-slate-400 hover:bg-slate-800/50 hover:text-white"
              }`}
            >
              <div className="flex items-center gap-3">
